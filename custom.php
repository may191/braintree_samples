    ...
    <div class="container theme-showcase" role="main" style="margin-top:90px">
      ...
      <div class="jumbotron">
        ...
        <script>
          ...
          //also setup the PayPal button too.
          braintree.setup("<?=$clientToken; ?>", "paypal", {container: 'paypal_div', paymentMethodNonceInputField: 'paypal_nonce' });
        ...
        <form id="checkout" method="post" action="process/checkout.php">
          ...
          <fieldset>
            ...
            <!-- This is where paypal options will go. -->
            <div id="paypal_div"></div> 
            <input type="hidden" id="paypal_nonce" name="paypal_nonce" value="" />
            <!-- End where PayPal will go. -->
            <p style="textalign:center;font-size:10px;margin-top:10px;"> --------- Or -------- </p>

            <div class="form-group">
              <label for="ccn">Card Number:</label>
              <input type="text" class="form-control" id="ccn" data-braintree-name="number" value="4111111111111111">
            </div>
            <div class="form-group">
              <label for="cce">Card Expiry (mm/yy):</label>
              <input type="text" class="form-control" id="cce" data-braintree-name="expiration_date" maxlength="5" value="11/17">
            </div>
          </fieldset>
          </div>
